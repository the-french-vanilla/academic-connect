      ...
      <div>
        <ul className="nav nav-tabs" id="myTab" role="tablist">
          ...
          <li className="nav-item" role="pages">
            <Link className="nav-link active" to="/search/results/pages" id="pages-tab" data-toggle="tab" role="tab" aria-controls="pages" aria-selected="true">
              Pages
            </Link>
          </li>
        ...
        <div className="tab-content" id="myTabContent">
          <div className="tab-pane fade show active" id="pages" role="tabpanel" aria-labelledby="pages-tab">
            Pages
          </div>
        </div>
      </div>
