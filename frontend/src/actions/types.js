...
export const GET_MUTUAL_CONNECTIONS = "GET_MUTUAL_CONNECTIONS";
export const SET_NUM_CONNECTIONS = "SET_NUM_CONNECTIONS";
export const SET_NUM_MUTUAL_CONNECTIONS = "SET_NUM_MUTUAL_CONNECTIONS";
export const SET_IS_CONNECTED = "SET_IS_CONNECTED";
export const UNCONNECT = "UNCONNECT";
export const GET_CONNECTION_RECOMMENDATIONS = "GET_CONNECTION_RECOMMENDATIONS";
...
export const GET_USER_PROFILES_BY_ID = "GET_USER_PROFILES_BY_ID";